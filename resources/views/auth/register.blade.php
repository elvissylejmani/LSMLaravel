            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="Surename" class="col-md-4 col-form-label text-md-right">{{ __('Surename') }}</label>

                            <div class="col-md-6">
                                <input id="Surename" type="text" class="form-control @error('Surename') is-invalid @enderror" name="Surename" value="{{ old('Surename') }}" required autocomplete="Surename" autofocus>
